...
<h1 className="text-one text-3xl font-extrabold" >Choose  Question</h1>
    {/* Category */}
...
<div  ref={sectionRef} className="">
 {dataex && dataex.length > 0 &&(  <h2 className="text-center text-one text-2xl py-4 font-medium">Questions</h2>
)}
