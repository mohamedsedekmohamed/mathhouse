...
<div className='max-w-screen overflow-hidden '>
  <Router>
    ...
    {/*  البطارية ثابتة */}
    <div className="fixed bottom-4 right-4 z-10   rounded-full p-2 flex flex-col gap-5" >
      <a href="https://www.tiktok.com/@mramirhemaida" target="_blank" rel="noopener noreferrer">
  <FaTiktok className="text-one w-7 h-7 md:w-10 md:h-10  hover:text-red-500 transition" />
</a>
...
<a href="https://wa.me/201234567890" target="_blank" rel="noopener noreferrer">
  <FaWhatsapp className="text-one w-7 h-7 md:w-10 md:h-10  hover:text-green-500 transition" />
</a>

<a href="https://www.youtube.com/@MathsHouse244/shorts" target="_blank" rel="noopener noreferrer">
  <FaYoutube className="text-one w-7 h-7 md:w-10 md:h-10  hover:text-red-600 transition" />
</a>
